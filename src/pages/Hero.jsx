      ...
      <div className="flex max-lg:flex-col-reverse flex-row justify-between items-center relative">
        ...
        <div className="max-lg:w-full max-lg:h-[310px] flex justify-center items-center">
          <div className = " lg:hidden relative">
              ...
              <img className = 'absolute top-[10px] right-[70px] animate-rotate4'src = {mobMegaphone}></img>
              <img className = 'absolute top-[10px] right-[60px] animate-heart'src = {mobHeart}></img>
              <img className = 'absolute top-[30px] right-[5px] animate-share'src = {mobShare}></img>
              <img className = 'absolute top-[80px] right-[10px] animate-play'src = {mobPlay}></img>
              <img className = 'absolute top-[135px] right-[15px] animate-location'src = {mobLocation}></img>

                {/* stars */}
              <img className = 'absolute bottom-[30px] left-[140px] animate-spin-slow'src = {mobStarCross}></img>
              <img className = 'absolute bottom-[50px] left-[20px] animate-spin-slow'src = {mobStarPlus}></img>
          </div>
